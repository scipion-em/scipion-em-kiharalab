...
EMAP2SEC_MODE_DETECT_STRUCTS = 0
EMAP2SEC_MODE_DETECT_EVALUATE_STRUCTS = 1
EMAP2SEC_MODE_DETECT_EXPERIMENTAL_FOLD4 = 2
EMAP2SEC_MODE_DETECT_EVALUATE_EXPERIMENTAL_FOLD4 = 3
EMAP2SEC_RESIZE_NUMBA = 0
EMAP2SEC_RESIZE_SCIPY = 1
EMAP2SEC_FOLD1 = 0
EMAP2SEC_FOLD2 = 1
EMAP2SEC_FOLD3 = 2
EMAP2SEC_FOLD4 = 3